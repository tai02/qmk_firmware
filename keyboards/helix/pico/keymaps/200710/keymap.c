...
#define RAISE_EISU LT(_RAISE, KC_LANG2)
#define RAISE_KANA LT(_RAISE, KC_LANG1)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+-------------+------+------+------+------+------+------|
   * | Esc  |Adjust| Alt  | GUI  | EISU |Raise |Space |Return|  BS  | KANA | GUI  | Alt  |   ←  |  →   |
   * `-------------------------------------------------------------------------------------------------'
   */
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_DOWN, KC_UP,  KC_LALT, KC_LGUI, RAISE_EISU, KC_SPC, KC_ESC,    KC_BSPC, KC_ENT, RAISE_KANA,  KC_RGUI, KC_RALT, KC_LEFT, KC_RGHT  \
  ),
  /* Colemak
   * ,-----------------------------------------.             ,-----------------------------------------.
  ...
  [_RAISE] = LAYOUT( \
    ...
    _______, KC_MINS, JP_DQUO, JP_QUOT, LALT(KC_INT3), JP_TILD,                         KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, JP_LCBR, JP_RCBR, \
    _______, JP_EXLM, JP_CIRC, JP_HASH, JP_DLR,        JP_PERC,                         JP_AMPR, JP_PIPE, JP_LPRN, JP_RPRN, JP_LBRC, JP_RBRC, \
    _______, _______,       _______, _______, _______, _______, _______,     KC_DELETE, _______, _______, _______, _______, KC_DOWN, KC_UP \
  ),
