...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT(
    ...
    MO(FUNC),  MO(FUNC), KC_LALT, KC_LGUI, KC_LANG2, KC_SPC,                        KC_BSPC, KC_ENT, KC_LANG1, KC_RGUI, MO(FUNC), KC_LEFT, KC_DOWN,   KC_RIGHT
  ),
  [FUNC] = LAYOUT(
    /* Left */                                                                     /* Right */
    _______, _______, _______, _______, _______, _______,  _______,              KC_TAB,  KC_PSLS, KC_PAST, KC_PMNS, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______,                        _______, KC_7,    KC_8,    KC_9,    KC_PPLS, _______, _______, _______,
    _______, _______, _______, _______, _______, _______,                        _______, KC_4,    KC_5,    KC_6,    KC_ENT,  _______, _______,
